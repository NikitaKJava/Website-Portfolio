...
<footer class="footer container" id="contacts">
    <div class="footer__inner card">
        <div class="footer__body">
            <div class="footer__title h2"> Do you want to discuss<br class="hidden-mobile">
                <span class="accent-color">your project?</span>
            </div>
        ...
        <div class="footer__contacts">
            <div class="footer__socials socials">
                <ul class="socials__list flow">
                    ...
                    <li class="socials__item">
                        <a class="socials__link" href="https://t.me/nikkoz1" target="_blank" title="Telegram"
                           aria-label="Telegram">
...
<div class="preloader  is-animation-started">
